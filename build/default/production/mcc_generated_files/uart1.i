...
# 239 "mcc_generated_files/uart1.c"
void UART1_Transmit_ISR(void)
{
...
void UART1_Receive_ISR(void)
{
    ...
    if(U1ERRIRbits.RXFOIF || new_message_in_rx1_buffer){
...
# 294 "mcc_generated_files/uart1.c"
void UART1_RxDataHandler(void){


    uart1RxBuffer[uart1RxHead] = U1RXB;

    if((uart1RxBuffer[uart1RxHead]=='\n' && uart1RxBuffer[uart1RxHead-1]=='\r') || (uart1RxHead == sizeof(uart1RxBuffer)-4) ) {
        uart1RxBuffer[uart1RxHead+1]='\0';
        new_message_in_rx1_buffer=1;
        uart1RxHead=0;
    }
    uart1RxHead++;
}
