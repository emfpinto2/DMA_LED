...
# 1 "mcc_generated_files/..\\my_defs.h" 1
# 11 "mcc_generated_files/..\\my_defs.h"
...
# 11 "mcc_generated_files/..\\my_defs.h" 2
# 66 "mcc_generated_files/..\\my_defs.h"
enum CAN_MSGs{
...
_Bool UART2_is_rx_ready(void)
{
    return (uart2RxCount ? 1 : 0);
}

_Bool UART2_is_tx_ready(void)
{
    return (uart2TxBufferRemaining ? 1 : 0);
}
...
void UART2_Receive_ISR(void)
{
    ...
    if(U2ERRIRbits.RXFOIF || new_message_in_rx2_buffer){
...
# 283 "mcc_generated_files/uart2.c"
void UART2_RxDataHandler(void){

    uart2RxBuffer[uart2RxHead] = U2RXB;

    if((uart2RxBuffer[uart2RxHead]=='\n' && uart2RxBuffer[uart2RxHead-1]=='\r') || (uart2RxHead == sizeof(uart2RxBuffer)-4) ) {
        uart2RxBuffer[uart2RxHead+1]='\0';
        new_message_in_rx2_buffer=1;
        uart2RxHead=0;
    }
    uart2RxHead++;
}
